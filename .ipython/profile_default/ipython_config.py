...
c.TerminalInteractiveShell.highlighting_style_overrides = {
    ...
    ## Affect IPython not ipdb
    Token.Number: '#ffffff',
    Token.Operator: 'noinherit',
    Token.String: '#fe8019',
    Token.Name.Function: '#fe8019',
    Token.Name.Class: 'bold #fe8019',
...
coloransi.color_templates = (
    ...
    ## Gruvbox 256-colors
    ("gb_bright_red", "38;5;167"),
    ("gb_bright_green", "38;5;142"),
    ("gb_bright_yellow", "38;5;214"),
    ("gb_bright_blue", "38;5;109"),
    ("gb_bright_purple", "38;5;175"),
    ("gb_bright_aqua", "38;5;108"),
    ("gb_bright_orange", "38;5;208"),
    
    ("gb_neutral_red", "38;5;124"),
    ("gb_neutral_green", "38;5;106"),
    ("gb_neutral_yellow", "38;5;172"),
    ("gb_neutral_blue", "38;5;66"),
    ("gb_neutral_purple", "38;5;132"),
    ("gb_neutral_aqua", "38;5;72"),
    ("gb_neutral_orange", "38;5;166"),

    ("gb_faded_purple", "38;5;96"),
    ("gb_faded_yellow", "38;5;136"),

    ("gb_light1", "38;5;223"), #default font color
    ("gb_light2", "38;5;250"), #
    ("gb_light3", "38;5;248"), #
    ("gb_light4", "38;5;246"), #
    ("gb_gray", "38;5;245"), #
...
def exception_colors():
    ...
    ex_colors.add_scheme(coloransi.ColorScheme(
        ...
        valEm=C.gb_neutral_purple, #affects parentheses n *.py(2)<module>()
...
# Does affect header, arrows, numbers
...
##
# Affects syntax highlighting from ll. Does not affect numbers, arrow, prompt
#
